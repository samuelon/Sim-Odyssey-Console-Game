...
extern EIF_TYPED_VALUE F1150_10137(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1150_10137 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1149, Current, 0, 0, 16426);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1149, Current, 16426);
	RTIV(Current, RTAL);
