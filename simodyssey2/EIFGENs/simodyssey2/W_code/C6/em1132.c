...
extern void F1132_9776(EIF_REFERENCE);
...
/* {EMPTY}.make */
void F1132_9776 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1131, Current, 0, 0, 16068);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1131, Current, 16068);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(7444, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) -10000000L);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
