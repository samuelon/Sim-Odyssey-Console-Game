...
extern void F1139_9854(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1139_9855(EIF_REFERENCE);
extern void F1139_9856(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1139_9852 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(7541,Dtype(Current)));
	return r;
}
...
/* {JANITAUR}.make */
void F1139_9854 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1138, Current, 0, 3, 16145);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(7515, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
	RTHOOK(9);
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(7513, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 5L);
	RTHOOK(14);
	...
	*(EIF_BOOLEAN *)(Current + RTWA(7475, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	RTHOOK(17);
	RTDBGAA(Current, dtype, 7541, 0x10000000, 1); /* load */
	*(EIF_INTEGER_32 *)(Current + RTWA(7541, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
	RTHOOK(18);
	RTDBGAA(Current, dtype, 7542, 0x10000000, 1); /* max_load */
	*(EIF_INTEGER_32 *)(Current + RTWA(7542, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(19);
	RTDBGLE;
...
/* {JANITAUR}.add_load */
void F1139_9855 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7541, 0x10000000, 1); /* load */
	(*(EIF_INTEGER_32 *)(Current + RTWA(7541, dtype)))++;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
		RTCT("valid", EX_POST);
		ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(7541, dtype));
...
/* {JANITAUR}.set_load */
void F1139_9856 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1138, Current, 0, 1, 16147);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1138, Current, 16147);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7541, 0x10000000, 1); /* load */
	*(EIF_INTEGER_32 *)(Current + RTWA(7541, dtype)) = (EIF_INTEGER_32) arg1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1138, Current, 0, 0, 16148);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1138, Current, 16148);
	RTIV(Current, RTAL);
	RTHOOK(1);
