...
extern EIF_TYPED_VALUE F1128_9725(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1128_9726(EIF_REFERENCE);
...
extern EIF_TYPED_VALUE F1128_9730(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1128_9725 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F1128_9726 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F1128_9730 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1127, Current, 0, 1, 16022);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1127, Current, 16022);
	RTIV(Current, RTAL);
	RTHOOK(1);
