...
extern EIF_TYPED_VALUE F1136_9821(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1136_9822(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1136_9823(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1136_9824(EIF_REFERENCE);
extern void F1136_9825(EIF_REFERENCE);
extern void F1136_9826(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1136_9827(EIF_REFERENCE);
extern void F1136_9828(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1136_9829(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1136_9830(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1136_9831(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1136_9832(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1136_9833(EIF_REFERENCE);
...
/* {EBMJ_COMMON}.fuel */
EIF_TYPED_VALUE F1136_9821 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F1136_9822 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F1136_9823 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
EIF_TYPED_VALUE F1136_9824 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
void F1136_9825 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1135, Current, 0, 0, 16123);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1135, Current, 16123);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7512, 0x10000000, 1); /* fuel */
	(*(EIF_INTEGER_32 *)(Current + RTWA(7512, dtype)))--;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
void F1136_9826 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1135, Current, 0, 1, 16124);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1135, Current, 16124);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7512, 0x10000000, 1); /* fuel */
...
EIF_TYPED_VALUE F1136_9827 (EIF_REFERENCE Current)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1135, Current, 3, 0, 16112);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1135, Current, 16112);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1136_9828 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1135, Current, 0, 1, 16113);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1135, Current, 16113);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7514, 0x10000000, 1); /* actions_left_until_reproduction */
...
void F1136_9829 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1135, Current, 0, 0, 16114);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1135, Current, 16114);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7514, 0x10000000, 1); /* actions_left_until_reproduction */
	(*(EIF_INTEGER_32 *)(Current + RTWA(7514, dtype)))--;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
EIF_TYPED_VALUE F1136_9830 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1135, Current, 2, 1, 16115);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1135, Current, 16115);
	RTCC(arg1, 1135, l_feature_name, 1, eif_new_type(1135, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	for (;;) {
		...
		RTNHOOK(2,1);
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7465, "is_asteroid", tr1))(tr1)).it_b);
		if (tb2) {
			RTHOOK(3);
	...
	ur1 = tr1;
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(4721, "plus", tr2))(tr2, ur1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7468, "get_sector", arg1))(arg1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(5,1);
...
EIF_TYPED_VALUE F1136_9831 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1135, Current, 0, 1, 16116);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1135, Current, 16116);
	RTCC(arg1, 1135, l_feature_name, 1, eif_new_type(1135, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF80000E8, 0,0); /* Result */
...
/* {EBMJ_COMMON}.fuel_str */
EIF_TYPED_VALUE F1136_9832 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "fuel_str";
	RTEX;
	EIF_TYPED_VALUE up1x = {{0}, SK_POINTER};
#define up1 up1x.it_p
	EIF_TYPED_VALUE ur1x = {{0}, SK_REF};
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1135, Current, 0, 0, 16117);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1135, Current, 16117);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF80000E8, 0,0); /* Result */
...
/* {EBMJ_COMMON}.actions_left_until_reproduction_str */
EIF_TYPED_VALUE F1136_9833 (EIF_REFERENCE Current)
{
	GTCX
	char *l_feature_name = "actions_left_until_reproduction_str";
	RTEX;
	EIF_TYPED_VALUE up1x = {{0}, SK_POINTER};
#define up1 up1x.it_p
	EIF_TYPED_VALUE ur1x = {{0}, SK_REF};
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1135, Current, 0, 0, 16118);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1135, Current, 16118);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF80000E8, 0,0); /* Result */
	tr1 = RTMS_EX_H("actions_left_until_reproduction:",32,337045562);
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(7514, dtype));
	tr2 = c_outi(ti4_1);
	ur1 = RTCCL(tr2);
	tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(4721, "plus", tr1))(tr1, ur1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
