...
extern EIF_TYPED_VALUE F1151_10116(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1151_10116 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1150, Current, 0, 0, 16406);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1150, Current, 16406);
	RTIV(Current, RTAL);
