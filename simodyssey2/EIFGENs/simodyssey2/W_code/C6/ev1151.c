...
extern EIF_TYPED_VALUE F1151_10138(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1151_10138 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1150, Current, 0, 0, 16427);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 1);
	RTDBGEAA(1150, Current, 16427);
	RTIV(Current, RTAL);
