...
extern EIF_TYPED_VALUE F1144_9822(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1144_9823(EIF_REFERENCE);
extern void F1144_9824(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1144_9825(EIF_REFERENCE);
extern void F1144_9826(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {JANITAUR}.load */
EIF_TYPED_VALUE F1144_9822 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
/* {JANITAUR}.make */
void F1144_9824 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1143, Current, 0, 3, 16116);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1143, Current, 16116);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(7504, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 5L);
	RTHOOK(13);
	...
	*(EIF_BOOLEAN *)(Current + RTWA(7468, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	RTHOOK(16);
	RTDBGAA(Current, dtype, 7515, 0x10000000, 1); /* load */
	*(EIF_INTEGER_32 *)(Current + RTWA(7515, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 0L);
	RTHOOK(17);
	RTDBGAA(Current, dtype, 7516, 0x10000000, 1); /* max_load */
	*(EIF_INTEGER_32 *)(Current + RTWA(7516, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(18);
	RTDBGLE;
...
/* {JANITAUR}.add_load */
void F1144_9825 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1143, Current, 0, 0, 16117);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1143, Current, 16117);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7515, 0x10000000, 1); /* load */
...
/* {JANITAUR}.set_load */
void F1144_9826 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1143, Current, 0, 1, 16118);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1143, Current, 16118);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7515, 0x10000000, 1); /* load */
	*(EIF_INTEGER_32 *)(Current + RTWA(7515, dtype)) = (EIF_INTEGER_32) arg1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
