...
extern EIF_TYPED_VALUE F1137_9836(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1137_9837(EIF_REFERENCE);
extern void F1137_9838(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F1137_9839(EIF_REFERENCE);
extern void F1137_9840(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1137_9841(EIF_REFERENCE);
extern void F1137_9842(EIF_REFERENCE);
extern void F1137_9843(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1137_9844(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1137_9845(EIF_REFERENCE);
extern void F1137_9846(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1137_9847(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1137_9848(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1137_9849(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1137_9834 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(7525,Dtype(Current)));
	return r;
}
...
/* {EXPLORER}.face_error */
EIF_TYPED_VALUE F1137_9836 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(7527,Dtype(Current)));
	return r;
}


/* {EXPLORER}.wins */
EIF_TYPED_VALUE F1137_9837 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
/* {EXPLORER}.make */
void F1137_9838 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1136, Current, 0, 3, 16129);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(7512, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
	RTHOOK(3);
	RTDBGAA(Current, dtype, 7525, 0x10000000, 1); /* life */
	*(EIF_INTEGER_32 *)(Current + RTWA(7525, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
	RTHOOK(4);
	RTDBGAA(Current, dtype, 7526, 0x04000000, 1); /* landed */
	*(EIF_BOOLEAN *)(Current + RTWA(7526, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	RTHOOK(5);
	RTDBGAA(Current, dtype, 7528, 0x04000000, 1); /* wins */
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(7513, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 3L);
	RTHOOK(10);
	RTDBGAA(Current, dtype, 7527, 0x04000000, 1); /* face_error */
	*(EIF_BOOLEAN *)(Current + RTWA(7527, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	RTHOOK(11);
...
/* {EXPLORER}.set_life */
void F1137_9840 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1136, Current, 0, 1, 16131);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7525, 0x10000000, 1); /* life */
	*(EIF_INTEGER_32 *)(Current + RTWA(7525, dtype)) = (EIF_INTEGER_32) arg1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
void F1137_9841 (EIF_REFERENCE Current)
{
	...
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7527, 0x04000000, 1); /* face_error */
	*(EIF_BOOLEAN *)(Current + RTWA(7527, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
void F1137_9843 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(7525, dtype));
	tr1 = c_outi(ti4_1);
...
/* {EXPLORER}.dec_life */
void F1137_9846 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7525, 0x10000000, 1); /* life */
	(*(EIF_INTEGER_32 *)(Current + RTWA(7525, dtype)))--;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
EIF_TYPED_VALUE F1137_9848 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1136, Current, 0, 0, 16139);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1136, Current, 16139);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF80000E8, 0,0); /* Result */
	tr1 = RTMS_EX_H("Explorer got lost in space - out of life support at Sector:",59,1527144506);
	tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7468, "get_sector", Current))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(1,1);
...
EIF_TYPED_VALUE F1137_9849 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1136, Current, 0, 0, 16140);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1136, Current, 16140);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0xF80000E8, 0,0); /* Result */
