...
extern void F1632_13364(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1632_13365(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1632_13366(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1632_13369(EIF_REFERENCE);
static EIF_TYPED_VALUE F1632_13370_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1632_13370(EIF_REFERENCE);
...
void F1632_13364 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1631, Current, 0, 0, 20066);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1631, Current, 20066);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 10290, 0xF800014F, 0); /* child_array */
	tr1 = RTLNSMART(RTWCT(10290, dtype, Dftype(Current)).id);
...
EIF_TYPED_VALUE F1632_13365 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1631, Current, 0, 1, 20067);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1631, Current, 20067);
	RTIV(Current, RTAL);
...
EIF_TYPED_VALUE F1632_13366 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1631, Current, 0, 0, 20068);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1631, Current, 20068);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1632_13369 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
static EIF_TYPED_VALUE F1632_13370_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1631, Current, 0, 0, 20070);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1631, Current, 20070);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1632_13370 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9665, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1632_13370_body (Current)).it_r;
