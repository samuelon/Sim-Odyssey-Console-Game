...
extern EIF_TYPED_VALUE F1329_11957(EIF_REFERENCE);
extern void F1329_11958(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1329_11957 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1329_11958 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1328, Current, 0, 0, 18809);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8738, 0xF80005BC, 0); /* implementation */
