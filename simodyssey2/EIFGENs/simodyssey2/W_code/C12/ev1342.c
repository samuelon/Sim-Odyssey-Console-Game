...
extern void F1342_12150(EIF_REFERENCE);
...
void F1342_12150 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1341, Current, 0, 0, 19002);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1341, Current, 19002);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(8726, 1340))(Current);
	RTHOOK(3);
	...
	*((EIF_REFERENCE *)tr2+0) = (EIF_REFERENCE) tr3;
	...
	ur1 = RTCCL(tr1);
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(9375, dtype))(Current, ur1x);
	RTHOOK(7);
