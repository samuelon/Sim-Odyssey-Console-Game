...
extern EIF_TYPED_VALUE F1328_11953(EIF_REFERENCE);
extern void F1328_11954(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1328_11953 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1328_11954 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1327, Current, 0, 0, 18805);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1327, Current, 18805);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8736, 0xF80005BB, 0); /* implementation */
