...
extern void F1471_13997(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1471_13998(EIF_REFERENCE);
static EIF_TYPED_VALUE F1471_13999_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1471_13999(EIF_REFERENCE);
...
void F1471_13997 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1470, Current, 0, 1, 20549);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1470, Current, 20549);
	RTCC(arg1, 1470, l_feature_name, 1, RTWCT(9667, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1471_13998 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1470, Current, 0, 0, 20550);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1470, Current, 20550);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10695, dtype))(Current)).it_b);
	ub1 = tb1;
	...
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9662, 1469))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(3);
...
static EIF_TYPED_VALUE F1471_13999_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1470, Current, 0, 0, 20551);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1470, Current, 20551);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1471_13999 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9667, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1471_13999_body (Current)).it_r;
