...
extern void F1471_13975(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1471_13976(EIF_REFERENCE);
static EIF_TYPED_VALUE F1471_13977_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1471_13977(EIF_REFERENCE);
...
void F1471_13975 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1470, Current, 0, 1, 20528);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1470, Current, 20528);
	RTCC(arg1, 1470, l_feature_name, 1, RTWCT(9651, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1471_13976 (EIF_REFERENCE Current)
{
	GTCX
...
static EIF_TYPED_VALUE F1471_13977_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1471_13977 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9651, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1471_13977_body (Current)).it_r;
