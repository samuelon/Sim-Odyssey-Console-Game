...
extern void F1513_14655(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1513_14656(EIF_REFERENCE);
static EIF_TYPED_VALUE F1513_14657_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1513_14657(EIF_REFERENCE);
...
void F1513_14655 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1512, Current, 0, 1, 21032);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1512, Current, 21032);
	RTCC(arg1, 1512, l_feature_name, 1, RTWCT(9665, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1513_14656 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1512, Current, 1, 0, 21033);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1512, Current, 21033);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	RTHOOK(6);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(9660, 1511))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(7);
...
static EIF_TYPED_VALUE F1513_14657_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1512, Current, 0, 0, 21034);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1512, Current, 21034);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1513_14657 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9665, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1513_14657_body (Current)).it_r;
