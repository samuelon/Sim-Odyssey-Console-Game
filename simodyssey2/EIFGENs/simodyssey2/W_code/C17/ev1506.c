...
static EIF_TYPED_VALUE F1506_14476_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1506_14476(EIF_REFERENCE);
extern void F1506_14477(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1506_14478(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1506_14479(EIF_REFERENCE);
extern void F1506_14480(EIF_REFERENCE);
extern void F1506_14481(EIF_REFERENCE);
extern void F1506_14482(EIF_REFERENCE);
extern void F1506_14483(EIF_REFERENCE);
extern void F1506_14484(EIF_REFERENCE);
...
#define ui1_1 ui1_1x.it_i1
	...
	RTEAA(l_feature_name, 1505, Current, 0, 0, 20860);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1505, Current, 20860);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
static EIF_TYPED_VALUE F1506_14476_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1505, Current, 0, 0, 20861);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1505, Current, 20861);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1506_14476 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9665, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1506_14476_body (Current)).it_r;
...
void F1506_14477 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_b
	...
	RTEAA(l_feature_name, 1505, Current, 0, 1, 20852);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1505, Current, 20852);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1505, Current, 0, 0, 20853);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1505, Current, 20853);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1506_14479 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(11032,Dtype(Current)));
	return r;
}
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1505, Current, 0, 0, 20855);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1505, Current, 20855);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10434, dtype))(Current)).it_p);
	up1 = tp1;
...
void F1506_14481 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1505, Current, 0, 0, 20856);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1505, Current, 20856);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10434, dtype))(Current)).it_p);
	up1 = tp1;
...
void F1506_14482 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1505, Current, 0, 0, 20857);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1505, Current, 20857);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 11032, 0x04000000, 1); /* is_tabable_from */
	*(EIF_BOOLEAN *)(Current + RTWA(11032, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
		RTCT("is_tabable_from", EX_POST);
		tb1 = *(EIF_BOOLEAN *)(Current + RTWA(11032, dtype));
		if (tb1) {
			RTCK;
		} else {
			RTCF;
...
void F1506_14483 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1505, Current, 0, 0, 20858);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1505, Current, 20858);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 11032, 0x04000000, 1); /* is_tabable_from */
	*(EIF_BOOLEAN *)(Current + RTWA(11032, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
void F1506_14484 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1505, Current, 0, 0, 20859);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1505, Current, 20859);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10175, dtype))(Current)).it_b);
	if (tb1) {
