...
static const EIF_TYPE_INDEX egt_1_994 [] = {0xFF01,1627,993,0xFFFF};
...
static const EIF_TYPE_INDEX egt_14_994 [] = {0xFF01,991,0xFFFF};
...
static const struct desc_info desc_994[] = {
	...
	{EIF_GENERIC(egt_14_994), 15048, 0xFFFFFFFF},
};
void Init994(void)
{
	IDSC(desc_994, 0, 993);
