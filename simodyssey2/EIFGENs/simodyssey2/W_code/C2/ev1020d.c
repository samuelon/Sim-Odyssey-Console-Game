...
static const EIF_TYPE_INDEX egt_13_1020 [] = {0xFF01,1192,0xFFFF};
...
static const struct desc_info desc_1020[] = {
	...
	{EIF_GENERIC(egt_13_1020), 15185, 0xFFFFFFFF},
	{EIF_GENERIC(egt_14_1020), 15186, 0xFFFFFFFF},
