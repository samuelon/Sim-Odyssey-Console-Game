...
extern EIF_TYPED_VALUE F999_8701(EIF_REFERENCE);
extern void F999_16783(EIF_REFERENCE, int);
...
/* {ETF_MODEL_ACCESS}.m */
RTOID (F999_8701)
EIF_TYPED_VALUE F999_8701 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 998, Current, 0, 0, 15086);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(998, Current, 15086);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
void F999_16783 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 998, Current, 0, 16782);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("m = m", Current);
