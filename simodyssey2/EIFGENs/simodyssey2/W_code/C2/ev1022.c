...
extern EIF_TYPED_VALUE F1022_8829(EIF_REFERENCE, EIF_TYPED_VALUE);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1021, Current, 0, 0, 15208);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1021, Current, 15208);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF800014F, 0,0); /* Result */
	ub1 = (EIF_BOOLEAN) 1;
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6611, dtype))(Current, ub1x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1021, Current, 0, 0, 15209);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1021, Current, 15209);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF800014F, 0,0); /* Result */
...
EIF_TYPED_VALUE F1022_8829 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1021, Current, 6, 1, 15210);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTAOMS(8828,2);
	RTDBGEAA(1021, Current, 15210);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	for (;;) {
		...
		up1 = tp1;
		(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(8495, "share_from_pointer", loc6))(loc6, up1x);
		RTHOOK(9);
		...
		RTHOOK(10);
		RTCOMS32(tr1,8828,0,"j\000\000\000p\000\000\000e\000\000\000g\000\000\000",4,1785750887);
		ur1 = tr1;
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(11, "is_equal", loc4))(loc4, ur1x)).it_b);
		if (tb1) {
			RTHOOK(11);
			RTDBGAL(4, 0xF80000EE, 0, 0); /* loc4 */
			RTCOMS32(tr1,8828,1,"j\000\000\000p\000\000\000g\000\000\000",3,6975591);
