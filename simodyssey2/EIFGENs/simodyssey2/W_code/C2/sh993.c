...
extern void F993_16760(EIF_REFERENCE, int);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 992, Current, 0, 0, 15046);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F993_16760 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 992, Current, 0, 16759);
	RTSA(dtype);
	RTME(dtype, 0);
