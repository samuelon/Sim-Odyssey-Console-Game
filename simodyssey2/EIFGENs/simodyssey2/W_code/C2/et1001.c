...
extern EIF_TYPED_VALUE F1001_8736(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1001_8737(EIF_REFERENCE);
extern void F1001_8738(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1001_8739(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1001_8734 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(6516,Dtype(Current)));
	return r;
}
...
EIF_TYPED_VALUE F1001_8736 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1001_8737 (EIF_REFERENCE Current)
{
	GTCX
...
void F1001_8738 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1000, Current, 2, 1, 15123);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1000, Current, 15123);
	RTCC(arg1, 1000, l_feature_name, 1, eif_new_type(232, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 6518, 0xF800016A, 0); /* items */
	{
	...
	*(EIF_REFERENCE *)(Current + RTWA(6518, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6517, 0xF80000E8, 0); /* error_string */
	...
	*(EIF_REFERENCE *)(Current + RTWA(6517, dtype)) = (EIF_REFERENCE) tr1;
	...
	if ((EIF_BOOLEAN) !tb1) {
		RTHOOK(5);
		RTDBGAA(Current, dtype, 6516, 0x04000000, 1); /* error */
		*(EIF_BOOLEAN *)(Current + RTWA(6516, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
		RTHOOK(6);
		RTDBGAA(Current, dtype, 6517, 0xF80000E8, 0); /* error_string */
	...
	if (RTAL & CK_ENSURE) {
		...
		tb2 = '\01';
		tb3 = *(EIF_BOOLEAN *)(Current + RTWA(6516, dtype));
		if (tb3) {
			tb3 = '\0';
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6518, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			RTNHOOK(16,1);
...
void F1001_8739 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1000, Current, 1, 0, 15124);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1000, Current, 15124);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6518, dtype))(Current)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(1,1);
