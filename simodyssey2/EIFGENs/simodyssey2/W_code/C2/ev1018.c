...
extern EIF_TYPED_VALUE F1018_8817(EIF_REFERENCE, EIF_TYPED_VALUE);
...
EIF_TYPED_VALUE F1018_8817 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_i4
	...
	RTEAA(l_feature_name, 1017, Current, 1, 1, 15198);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1017, Current, 15198);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	tu4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6599, dtype))(Current)).it_n4);
