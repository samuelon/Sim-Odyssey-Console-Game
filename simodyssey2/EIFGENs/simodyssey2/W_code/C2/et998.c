...
extern EIF_TYPED_VALUE F998_8701(EIF_REFERENCE);
extern void F998_16783(EIF_REFERENCE, int);
...
/* {ETF_MODEL_ACCESS}.m */
RTOID (F998_8701)
EIF_TYPED_VALUE F998_8701 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 997, Current, 0, 0, 15084);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(997, Current, 15084);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF80003E7, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(999, 0x01).id);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(6485, Dtype(tr1)))(tr1);
	RTNHOOK(1,1);
...
void F998_16783 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 997, Current, 0, 16782);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("m = m", Current);
