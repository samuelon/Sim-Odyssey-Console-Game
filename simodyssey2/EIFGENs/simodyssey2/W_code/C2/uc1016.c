...
extern EIF_TYPED_VALUE F1016_8810(EIF_REFERENCE);
...
RTOID (F1016_8810)
EIF_TYPED_VALUE F1016_8810 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1015, Current, 0, 0, 15192);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1015, Current, 15192);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
