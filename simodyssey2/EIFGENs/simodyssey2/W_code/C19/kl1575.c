...
extern EIF_TYPED_VALUE F1575_15828(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1575_15829(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1575_15830(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1575_15831(EIF_REFERENCE);
...
RTOID (F1575_15828)
EIF_TYPED_VALUE F1575_15828 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1574, Current, 0, 0, 22081);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1574, Current, 22081);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	...
	if (RTAL & CK_ENSURE) {
		...
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(11830, "is_current_file_system", Result))(Result)).it_b);
		if (tb1) {
			RTCK;
		} else {
			RTCF;
...
RTOID (F1575_15829)
EIF_TYPED_VALUE F1575_15829 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1574, Current, 0, 0, 22082);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1574, Current, 22082);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000636, 0,0); /* Result */
	tr1 = RTLN(eif_new_type(1590, 0x01).id);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(11829, Dtype(tr1)))(tr1);
	RTNHOOK(1,1);
	Result = (EIF_REFERENCE) RTCCL(tr1);
	if (RTAL & CK_ENSURE) {
		RTHOOK(2);
...
RTOID (F1575_15830)
EIF_TYPED_VALUE F1575_15830 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1574, Current, 0, 0, 22083);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1574, Current, 22083);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF8000636, 0,0); /* Result */
...
RTOID (F1575_15831)
EIF_TYPED_VALUE F1575_15831 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1574, Current, 0, 0, 22084);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1574, Current, 22084);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
...
{
	GTCX
	RTOTS (15828,F1575_15828)
	RTOTS (15829,F1575_15829)
	RTOTS (15830,F1575_15830)
	RTOTS (15831,F1575_15831)
}
