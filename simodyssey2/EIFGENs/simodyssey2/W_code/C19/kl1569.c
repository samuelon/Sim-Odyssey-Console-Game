...
extern EIF_TYPED_VALUE F1569_15644(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1569_15644 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 1568, Current, 0, 0, 21933);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1568, Current, 21933);
	RTIV(Current, RTAL);
	RTHOOK(1);
