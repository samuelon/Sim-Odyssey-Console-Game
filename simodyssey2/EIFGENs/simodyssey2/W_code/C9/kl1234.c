...
extern EIF_TYPED_VALUE F1234_10792(EIF_REFERENCE);
...
RTOID (F1234_10792)
EIF_TYPED_VALUE F1234_10792 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1233, Current, 0, 0, 17452);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1233, Current, 17452);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
