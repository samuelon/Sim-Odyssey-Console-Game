...
extern EIF_TYPED_VALUE F1159_10269(EIF_REFERENCE);
static EIF_TYPED_VALUE F1159_10270_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1159_10270(EIF_REFERENCE);
...
extern void F1159_10275(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1159_10269 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	r.it_r = (Current + RTWA(7910,Dtype(Current)));
	return r;
}


/* {ACTION}.shared_info */
static EIF_TYPED_VALUE F1159_10270_body (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1158, Current, 0, 0, 16556);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1158, Current, 16556);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1159_10270 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		...
		RTLR(0,Current);
		RTLIU(1);
		r.it_r = (F1159_10270_body (Current)).it_r;
		*(EIF_REFERENCE *)(Current + RTWA(7911,Dtype(Current))) = r.it_r;
		RTAR(Current, r.it_r);
		RTLE;
	}
	return r;
...
EIF_TYPED_VALUE F1159_10274 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(7915,Dtype(Current)));
	return r;
}


/* {ACTION}.set_invalid */
void F1159_10275 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1158, Current, 0, 0, 16561);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1158, Current, 16561);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7915, 0x04000000, 1); /* invalid */
	*(EIF_BOOLEAN *)(Current + RTWA(7915, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
