...
extern void F1160_10276(EIF_REFERENCE);
extern void F1160_10277(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {ACT_WORMHOLE}.make */
void F1160_10276 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1159, Current, 0, 0, 16562);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1159, Current, 16562);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
void F1160_10277 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1159, Current, 6, 1, 16563);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1159, Current, 16563);
	...
	if (tb1) {
		...
		tb1 = '\01';
		tb2 = '\01';
		tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7459, "is_explorer", arg1))(arg1)).it_b);
		if (!tb3) {
			tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7461, "is_benign", arg1))(arg1)).it_b);
			tb2 = tb3;
		}
		if (!tb2) {
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7460, "is_malevolent", arg1))(arg1)).it_b);
			tb1 = tb2;
		}
		if (tb1) {
			RTHOOK(4);
			...
			for (;;) {
				...
				if ((EIF_BOOLEAN) !tb1) {
					...
					ti4_1 = *(EIF_INTEGER_32 *)(arg1 + RTVA(7444, "col", arg1));
					...
					RTHOOK(12);
					(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(7483, "set_use_wormhole", arg1))(arg1);
				}
			}
		}
	}
