...
extern EIF_TYPED_VALUE F1537_15049(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1537_15052(EIF_REFERENCE);
static EIF_TYPED_VALUE F1537_15053_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1537_15053(EIF_REFERENCE);
...
/* {EV_MENU_I}.parent */
EIF_TYPED_VALUE F1537_15049 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1536, Current, 1, 0, 21417);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1536, Current, 21417);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1537_15052 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1536, Current, 4, 0, 21418);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1536, Current, 21418);
	RTIV(Current, RTAL);
	if (RTAL & CK_ENSURE) {
		in_assertion = ~0;
	...
	for (;;) {
		...
		if ((EIF_BOOLEAN)(loc3 != NULL)) {
			tb3 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(8979, "is_selected", loc3))(loc3)).it_b);
			tb2 = tb3;
		}
		if (tb2) {
			RTHOOK(10);
...
/* {EV_MENU_I}.interface */
static EIF_TYPED_VALUE F1537_15053_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1536, Current, 0, 0, 21419);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1536, Current, 21419);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1537_15053 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9651, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1537_15053_body (Current)).it_r;
