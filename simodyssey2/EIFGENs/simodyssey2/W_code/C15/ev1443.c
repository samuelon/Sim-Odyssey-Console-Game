...
extern EIF_TYPED_VALUE F1443_13613(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1443_13613 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1442, Current, 0, 0, 20245);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1442, Current, 20245);
	RTIV(Current, RTAL);
	RTHOOK(1);
