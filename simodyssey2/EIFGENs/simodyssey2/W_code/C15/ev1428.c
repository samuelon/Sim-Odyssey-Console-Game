...
extern EIF_TYPED_VALUE F1428_13508(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1428_13509(EIF_REFERENCE);
extern void F1428_13510(EIF_REFERENCE);
extern void F1428_13511(EIF_REFERENCE);
extern void F1428_13512(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1428_13513_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1428_13513(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1428_13508 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
EIF_TYPED_VALUE F1428_13509 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
void F1428_13510 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1427, Current, 2, 0, 20169);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1427, Current, 20169);
	RTIV(Current, RTAL);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10398, 0x04000000, 1); /* is_docking_enabled */
	*(EIF_BOOLEAN *)(Current + RTWA(10398, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	RTHOOK(3);
	tr1 = RTLN(eif_new_type(1294, 0x01).id);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(32, Dtype(tr1)))(tr1);
	RTNHOOK(3,1);
	...
	if (EIF_TEST(loc1)) {
		...
		RTNHOOK(4,1);
		tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(9963, "dockable_targets", tr1))(tr1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTNHOOK(4,2);
...
void F1428_13511 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1427, Current, 2, 0, 20170);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1427, Current, 20170);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("application_exists", EX_PRE);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10398, 0x04000000, 1); /* is_docking_enabled */
	*(EIF_BOOLEAN *)(Current + RTWA(10398, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	RTHOOK(3);
	tr1 = RTLN(eif_new_type(1294, 0x01).id);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWC(32, Dtype(tr1)))(tr1);
	RTNHOOK(3,1);
...
void F1428_13512 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1427, Current, 0, 1, 20171);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1427, Current, 20171);
	if (arg1) {
		{
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10397, 0xF8000114, 0); /* veto_dock_function */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
static EIF_TYPED_VALUE F1428_13513_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1427, Current, 0, 0, 20172);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1427, Current, 20172);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1428_13513 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9651, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1428_13513_body (Current)).it_r;
