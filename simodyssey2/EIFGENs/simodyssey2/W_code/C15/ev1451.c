...
extern void F1451_13662(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1451_13663(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1451_13664(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1451_13665(EIF_REFERENCE);
extern void F1451_13666(EIF_REFERENCE, EIF_TYPED_VALUE);
static EIF_TYPED_VALUE F1451_13667_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1451_13667(EIF_REFERENCE);
extern void EIF_Minit1451(void);
extern EIF_REFERENCE _A1255_335();
extern EIF_REFERENCE _A1255_334();
...
void F1451_13662 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1450, Current, 0, 1, 20273);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1450, Current, 20273);
	RTCC(arg1, 1450, l_feature_name, 1, RTWCT(9665, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1451_13663 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1450, Current, 3, 0, 20274);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1450, Current, 20274);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1255_334, (EIF_POINTER)(0),8523, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
	ur3 = NULL;
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr3= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1255_335, (EIF_POINTER)(0),8524, 0, 0, 1, -1, tr2, 0);
	}
	ur2 = RTCCL(tr3);
	ur3 = NULL;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(10186, dtype))(Current, up1x, ur1x, ur2x, ur3x);
...
EIF_TYPED_VALUE F1451_13664 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1450, Current, 2, 0, 20275);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1451_13665 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1451_13666 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1450, Current, 1, 1, 20277);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1450, Current, 20277);
	RTCC(arg1, 1450, l_feature_name, 1, eif_new_type(185, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 10500, 0xF80000B9, 0); /* start_path */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
static EIF_TYPED_VALUE F1451_13667_body (EIF_REFERENCE Current)
{
	GTCX
...
EIF_TYPED_VALUE F1451_13667 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9665, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1451_13667_body (Current)).it_r;
