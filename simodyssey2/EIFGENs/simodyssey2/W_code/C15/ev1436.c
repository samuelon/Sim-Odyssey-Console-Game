...
extern EIF_TYPED_VALUE F1436_13543(EIF_REFERENCE);
extern void F1436_13544(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F1436_13547(EIF_REFERENCE);
static EIF_TYPED_VALUE F1436_13548_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1436_13548(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1436_13543 (EIF_REFERENCE Current)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTEAA(l_feature_name, 1435, Current, 3, 0, 20192);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
void F1436_13544 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1435, Current, 3, 1, 20193);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1435, Current, 20193);
...
body:;
	...
	RTHOOK(3);
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10422, dtype))(Current)).it_p);
	up1 = tp1;
	tp2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(10420, dtype))(Current)).it_p);
	up2 = tp2;
...
EIF_TYPED_VALUE F1436_13547 (EIF_REFERENCE Current)
{
	GTCX
...
static EIF_TYPED_VALUE F1436_13548_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1435, Current, 0, 0, 20191);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1435, Current, 20191);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1436_13548 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9651, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1436_13548_body (Current)).it_r;
