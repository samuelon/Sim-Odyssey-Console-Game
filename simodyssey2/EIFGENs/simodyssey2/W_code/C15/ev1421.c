...
static EIF_TYPED_VALUE F1421_13482_body(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1421_13482(EIF_REFERENCE);
extern void F1421_16853(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F1421_13481 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 1420, Current, 0, 0, 20155);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1420, Current, 20155);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x38000000, 1,0); /* Result */
	tr1 = RTLN(eif_new_type(1019, 0x01).id);
	tu4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6603, 1019))(tr1)).it_n4);
...
static EIF_TYPED_VALUE F1421_13482_body (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1420, Current, 0, 0, 20156);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1420, Current, 20156);
	RTIV(Current, RTAL);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(1);
...
EIF_TYPED_VALUE F1421_13482 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
	...
	if (!r.it_r) {
		if (RTAT(RTWCT(9665, Dtype(Current), Dftype(Current)))) {
			...
			RTLR(0,Current);
			RTLIU(1);
			r.it_r = (F1421_13482_body (Current)).it_r;
...
void F1421_16853 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 1420, Current, 0, 16852);
	RTSA(dtype);
	RTME(dtype, 0);
