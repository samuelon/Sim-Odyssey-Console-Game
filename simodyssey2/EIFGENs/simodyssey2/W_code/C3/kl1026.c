...
extern EIF_TYPED_VALUE F1026_8897(EIF_REFERENCE);
...
RTOID (F1026_8897)
EIF_TYPED_VALUE F1026_8897 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1025, Current, 0, 0, 15260);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1025, Current, 15260);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
