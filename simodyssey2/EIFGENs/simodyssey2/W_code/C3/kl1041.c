...
extern EIF_TYPED_VALUE F1041_8969(EIF_REFERENCE);
...
RTOID (F1041_8969)
EIF_TYPED_VALUE F1041_8969 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1040, Current, 0, 0, 15324);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1040, Current, 15324);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
