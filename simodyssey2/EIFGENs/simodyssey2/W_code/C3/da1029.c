...
extern EIF_TYPED_VALUE F1029_8925(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1029_8926(EIF_REFERENCE);
...
{
	GTCX
	RTOTC (F1029_8919,15275,RTMS_EX_H("English",7,257590376));
}
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1028, Current, 0, 0, 15277);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1028, Current, 15277);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF800014E, 0,0); /* Result */
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1028, Current, 0, 0, 15278);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1028, Current, 15278);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(0, 0xF800014E, 0,0); /* Result */
...
{
	GTCX
	RTOTC (F1029_8924,15280,RTMS_EX_H("[0]mm/[0]dd/yyyy",16,1621628025));
}
...
EIF_TYPED_VALUE F1029_8925 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1029_8925,15281,RTMS_EX_H("hh12:[0]mi:[0]ss.ff3 AM",23,629041741));
}
...
EIF_TYPED_VALUE F1029_8926 (EIF_REFERENCE Current)
{
	GTCX
	RTOTC (F1029_8926,15282,RTMS_EX_H("[0]mm/[0]dd/yyyy hh12:[0]mi:[0]ss.ff3 AM",40,2104244301));
}
...
void EIF_Minit1029 (void)
{
	...
	RTOTS (8925,F1029_8925)
	RTOTS (8926,F1029_8926)
}
