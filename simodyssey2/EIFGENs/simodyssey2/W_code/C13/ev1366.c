...
extern EIF_TYPED_VALUE F1366_12366(EIF_REFERENCE);
extern void F1366_12367(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1366_12366 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1366_12367 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1365, Current, 0, 0, 19220);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1365, Current, 19220);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8722, 0xF80005FF, 0); /* implementation */
