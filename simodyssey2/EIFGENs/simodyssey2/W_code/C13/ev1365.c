...
extern EIF_TYPED_VALUE F1365_12383(EIF_REFERENCE);
extern void F1365_12384(EIF_REFERENCE);
...
EIF_TYPED_VALUE F1365_12383 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_REF;
...
void F1365_12384 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1364, Current, 0, 0, 19236);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 8736, 0xF80005FE, 0); /* implementation */
