...
extern EIF_TYPED_VALUE F1068_9315(EIF_REFERENCE);
...
RTOID (F1068_9315)
EIF_TYPED_VALUE F1068_9315 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1067, Current, 0, 0, 15634);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1067, Current, 15634);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
