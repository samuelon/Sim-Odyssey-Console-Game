...
extern void F980_16779(EIF_REFERENCE, int);
...
#define ui4_1 ui4_1x.it_i4
	...
	*(EIF_REFERENCE *)(Current + RTWA(6259, dtype)) = (EIF_REFERENCE) tr1;
	...
	RTNHOOK(6,1);
	tr2 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7400, "model", tr1))(tr1)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
	RTNHOOK(6,2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(6501, "reset", tr2))(tr2);
	RTHOOK(7);
	...
	*((EIF_INTEGER_32 *)tr4+0) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
	...
	
	{
		...
		typres0 = (typcache0.id != INVALID_DTYPE ? typcache0 : (typcache0 = eif_compound_id(dftype, typarr0)));
		tr5= RTLNRW(typres0.id, 0, (EIF_POINTER) _A1122_35_2, (EIF_POINTER)(0),7399, tr3, 0, 1, -1, tr1, 1);
	}
	ur1 = RTCCL(tr5);
		...
		*((EIF_INTEGER_32 *)tr4+0) = (EIF_INTEGER_32) ((EIF_INTEGER_32) 2L);
		...
		if (tb1) {
			...
			*(EIF_BOOLEAN *)(Current + RTWA(6253, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
			...
			RTNHOOK(10,1);
			tr3 = ((up2x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7395, "error_message", tr2))(tr2)), (((up2x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up2x.it_r = RTBU(up2x))), (up2x.type = SK_POINTER), up2x.it_r);
			ur1 = RTCCL(tr3);
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWC(4738, Dtype(tr1)))(tr1, ur1x);
			RTNHOOK(10,2);
			tr1 = RTCCL(tr1);
			...
			*(EIF_REFERENCE *)(Current + RTWA(6254, dtype)) = (EIF_REFERENCE) tr1;
			...
			RTNHOOK(13,1);
			ur1 = RTCCL(arg1);
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(6973, "execute_without_log", tr1))(tr1, ur1x);
			RTHOOK(14);
			RTDBGAA(Current, dtype, 6253, 0x04000000, 1); /* error */
			*(EIF_BOOLEAN *)(Current + RTWA(6253, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
			RTHOOK(15);
...
void F980_16779 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 979, Current, 0, 16778);
	RTSA(dtype);
	RTME(dtype, 0);
