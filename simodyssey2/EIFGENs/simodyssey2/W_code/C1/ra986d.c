...
static const EIF_TYPE_INDEX egt_1_986 [] = {0xFF01,1630,985,0xFFFF};
...
static const EIF_TYPE_INDEX egt_14_986 [] = {0xFF01,975,0xFFFF};
...
static const struct desc_info desc_986[] = {
	...
	{EIF_GENERIC(egt_14_986), 14846, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01BB /*221*/), 14847, 0xFFFFFFFF},
};
void Init986(void)
{
	IDSC(desc_986, 0, 985);
	IDSC(desc_986 + 1, 1, 985);
	IDSC(desc_986 + 32, 470, 985);
}
