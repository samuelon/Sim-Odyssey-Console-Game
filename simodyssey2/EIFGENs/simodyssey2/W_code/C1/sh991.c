...
extern EIF_TYPED_VALUE F991_8642(EIF_REFERENCE);
extern void F991_16780(EIF_REFERENCE, int);
...
RTOID (F991_8642)
EIF_TYPED_VALUE F991_8642 (EIF_REFERENCE Current)
{
	GTCX
...
void F991_16780 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up2 up2x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 990, Current, 0, 16779);
	RTSA(dtype);
	RTME(dtype, 0);
