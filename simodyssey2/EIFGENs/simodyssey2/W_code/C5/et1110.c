...
extern void F1110_9649(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {ETF_ARRAY_ARG}.make */
void F1110_9649 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1109, Current, 0, 1, 15945);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1109, Current, 15945);
	{
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7362, 0xF80000E8, 0); /* src_out */
	...
	*(EIF_REFERENCE *)(Current + RTWA(7362, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7364, 0xF800014E, 0); /* value */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1109, Current, 1, 0, 15946);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1109, Current, 15946);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	for (;;) {
		...
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7362, "src_out", tr2))(tr2)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTNHOOK(5,1);
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1109, Current, 4, 0, 15947);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	for (;;) {
		...
		if (EIF_TEST(loc4)) {
			RTHOOK(8);
			tb2 = *(EIF_BOOLEAN *)(loc4 + RTVA(7386, "value", loc4));
			ub1 = tb2;
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1109, Current, 4, 0, 15948);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	for (;;) {
		...
		if (EIF_TEST(loc4)) {
			RTHOOK(8);
			tc1 = *(EIF_CHARACTER_8 *)(loc4 + RTVA(7384, "value", loc4));
			uc1 = tc1;
			ti4_1 = *(EIF_INTEGER_32 *)(Result + RTVA(2780, "upper", Result));
			ui4_1 = (EIF_INTEGER_32) (ti4_1 + ((EIF_INTEGER_32) 1L));
...
body:;
	...
	for (;;) {
		...
		if (EIF_TEST(loc4)) {
			RTHOOK(8);
			ti8_1 = *(EIF_INTEGER_64 *)(loc4 + RTVA(7376, "value", loc4));
			ui8_1 = ti8_1;
			ti4_1 = *(EIF_INTEGER_32 *)(Result + RTVA(2780, "upper", Result));
			ui4_1 = (EIF_INTEGER_32) (ti4_1 + ((EIF_INTEGER_32) 1L));
...
body:;
	...
	for (;;) {
		...
		if (EIF_TEST(loc4)) {
			RTHOOK(8);
			ti4_1 = *(EIF_INTEGER_32 *)(loc4 + RTVA(7388, "value", loc4));
			ui4_1 = ti4_1;
			ti4_2 = *(EIF_INTEGER_32 *)(Result + RTVA(2780, "upper", Result));
			ui4_2 = (EIF_INTEGER_32) (ti4_2 + ((EIF_INTEGER_32) 1L));
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(2755, "force", Result))(Result, ui4_1x, ui4_2x);
...
body:;
	...
	for (;;) {
		...
		if (EIF_TEST(loc4)) {
			RTHOOK(8);
			tr8_1 = *(EIF_REAL_64 *)(loc4 + RTVA(7374, "value", loc4));
			ur8_1 = tr8_1;
			ti4_1 = *(EIF_INTEGER_32 *)(Result + RTVA(2780, "upper", Result));
			ui4_1 = (EIF_INTEGER_32) (ti4_1 + ((EIF_INTEGER_32) 1L));
...
body:;
	...
	for (;;) {
		...
		if (EIF_TEST(loc4)) {
			RTHOOK(8);
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7382, "value", loc4))(loc4)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			ur1 = RTCCL(tr1);
			ti4_1 = *(EIF_INTEGER_32 *)(Result + RTVA(2780, "upper", Result));
			ui4_1 = (EIF_INTEGER_32) (ti4_1 + ((EIF_INTEGER_32) 1L));
