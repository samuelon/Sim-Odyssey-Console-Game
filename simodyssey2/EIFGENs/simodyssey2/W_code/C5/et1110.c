...
extern void F1110_9639(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {ETF_ARRAY_ARG}.make */
void F1110_9639 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_r
	...
	RTEAA(l_feature_name, 1109, Current, 0, 1, 15942);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1109, Current, 15942);
	{
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7352, 0xF80000E8, 0); /* src_out */
	tr1 = RTLNSMART(RTWCT(7352, dtype, Dftype(Current)).id);
	...
	*(EIF_REFERENCE *)(Current + RTWA(7352, dtype)) = (EIF_REFERENCE) tr1;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7354, 0xF800014E, 0); /* value */
	tr1 = RTCCL(arg1);
	RTAR(Current, tr1);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1109, Current, 1, 0, 15943);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1109, Current, 15943);
	RTIV(Current, RTAL);
	RTHOOK(1);
	...
	for (;;) {
		...
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7352, "src_out", tr2))(tr2)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		RTNHOOK(5,1);
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1109, Current, 4, 0, 15935);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	for (;;) {
		...
		if (EIF_TEST(loc4)) {
			RTHOOK(8);
			tb2 = *(EIF_BOOLEAN *)(loc4 + RTVA(7370, "value", loc4));
			ub1 = tb2;
...
#define uc1 uc1x.it_c1
	...
	RTEAA(l_feature_name, 1109, Current, 4, 0, 15936);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		for (;;) {
			...
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3145, "item", loc1))(loc1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			loc2 = RTCCL(tr1);
			loc2 = RTRV(eif_new_type(1113, 0x01),loc2);
			tb1 = EIF_TEST(loc2);
			RTHOOK(4);
			(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(3147, "forth", loc1))(loc1);
		}
...
body:;
	...
	for (;;) {
		...
		tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(3145, "item", loc3))(loc3)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
		loc4 = RTCCL(tr1);
		loc4 = RTRV(eif_new_type(1113, 0x01),loc4);
		if (EIF_TEST(loc4)) {
			RTHOOK(8);
			tc1 = *(EIF_CHARACTER_8 *)(loc4 + RTVA(7368, "value", loc4));
			uc1 = tc1;
			ti4_1 = *(EIF_INTEGER_32 *)(Result + RTVA(2780, "upper", Result));
			ui4_1 = (EIF_INTEGER_32) (ti4_1 + ((EIF_INTEGER_32) 1L));
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1109, Current, 4, 0, 15937);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1109, Current, 4, 0, 15938);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1109, Current, 15938);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 1109, Current, 4, 0, 15939);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1109, Current, 15939);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		if (EIF_TEST(loc4)) {
			RTHOOK(8);
			ti4_1 = *(EIF_INTEGER_32 *)(loc4 + RTVA(7378, "value", loc4));
			ui4_1 = ti4_1;
			ti4_2 = *(EIF_INTEGER_32 *)(Result + RTVA(2780, "upper", Result));
			ui4_2 = (EIF_INTEGER_32) (ti4_2 + ((EIF_INTEGER_32) 1L));
			(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTVF(2755, "force", Result))(Result, ui4_1x, ui4_2x);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1109, Current, 4, 0, 15940);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1109, Current, 15940);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 1109, Current, 4, 0, 15941);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1109, Current, 15941);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	for (;;) {
		...
		if (EIF_TEST(loc4)) {
			RTHOOK(8);
			tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7366, "value", loc4))(loc4)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
			ur1 = RTCCL(tr1);
			ti4_1 = *(EIF_INTEGER_32 *)(Result + RTVA(2780, "upper", Result));
			ui4_1 = (EIF_INTEGER_32) (ti4_1 + ((EIF_INTEGER_32) 1L));
