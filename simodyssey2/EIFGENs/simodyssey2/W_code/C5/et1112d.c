...
static const struct desc_info desc_1112[] = {
	...
	{EIF_GENERIC(egt_9_1112), 15946, 0xFFFFFFFF},
	...
	{EIF_GENERIC(egt_13_1112), 15932, 0},
	{EIF_GENERIC(NULL), 15933, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 15944, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x099F /*1231*/), 15945, 32},
};
void Init1112(void)
{
	IDSC(desc_1112, 0, 1111);
	IDSC(desc_1112 + 1, 1, 1111);
	IDSC(desc_1112 + 32, 389, 1111);
	IDSC(desc_1112 + 34, 455, 1111);
}
