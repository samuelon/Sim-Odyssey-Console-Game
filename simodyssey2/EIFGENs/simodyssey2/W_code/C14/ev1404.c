...
extern void F1404_12966(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1404_12967(EIF_REFERENCE);
...
extern EIF_TYPED_VALUE F1404_12972(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1404_12973(EIF_REFERENCE);
...
void F1404_12966 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1403, Current, 0, 1, 19703);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1403, Current, 19703);
	RTCC(arg1, 1403, l_feature_name, 1, RTWCT(9667, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1404_12967 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1403, Current, 1, 0, 19705);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(6610, "readable_pixbuf_formats", loc1))(loc1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(4,1);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1403, Current, 0, 0, 19708);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F1404_12972 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1403, Current, 0, 0, 19709);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1403, Current, 19709);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
RTOID (F1404_12973)
EIF_TYPED_VALUE F1404_12973 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1403, Current, 1, 0, 19710);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1403, Current, 19710);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(1, 0xF8000580, 0, 0); /* loc1 */
	...
	RTHOOK(3);
	RTDBGAL(0, 0xF8000150, 0,0); /* Result */
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(8552, "font_names_on_system", loc1))(loc1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(3,1);
	tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2333, "linear_representation", tr1))(tr1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	Result = (EIF_REFERENCE) RTCCL(tr2);
	RTHOOK(4);
...
{
	GTCX
	RTOTS (12968,F1404_12968)
	RTOTS (12973,F1404_12973)
}
