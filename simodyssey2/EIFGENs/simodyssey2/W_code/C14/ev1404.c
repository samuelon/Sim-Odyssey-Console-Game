...
extern void F1404_12944(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F1404_12945(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1404_12946(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1404_12947(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1404_12948(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1404_12949(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1404_12950(EIF_REFERENCE);
extern EIF_TYPED_VALUE F1404_12951(EIF_REFERENCE);
...
void F1404_12944 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1403, Current, 0, 1, 19682);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1403, Current, 19682);
	RTCC(arg1, 1403, l_feature_name, 1, RTWCT(9651, dtype, Dftype(Current)), 0x01);
	RTIV(Current, RTAL);
...
void F1404_12945 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub1 ub1x.it_b
	...
	RTEAA(l_feature_name, 1403, Current, 0, 0, 19683);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1403, Current, 19683);
	RTIV(Current, RTAL);
	RTHOOK(1);
	ub1 = (EIF_BOOLEAN) 1;
...
RTOID (F1404_12946)
EIF_TYPED_VALUE F1404_12946 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1403, Current, 1, 0, 19684);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1403, Current, 19684);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
...
body:;
	...
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(6655, "readable_pixbuf_formats", loc1))(loc1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(4,1);
...
EIF_TYPED_VALUE F1404_12947 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 1403, Current, 0, 0, 19685);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1403, Current, 19685);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F1404_12948 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1403, Current, 0, 0, 19686);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1403, Current, 19686);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
...
EIF_TYPED_VALUE F1404_12949 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 1403, Current, 0, 0, 19687);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1403, Current, 19687);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(0, 0x10000000, 1,0); /* Result */
	tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5197, 966))(Current)).it_p);
...
EIF_TYPED_VALUE F1404_12950 (EIF_REFERENCE Current)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 1403, Current, 0, 0, 19688);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1403, Current, 19688);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
RTOID (F1404_12951)
EIF_TYPED_VALUE F1404_12951 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 1403, Current, 1, 0, 19689);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(1403, Current, 19689);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
	RTDBGAL(1, 0xF8000580, 0, 0); /* loc1 */
	...
	RTHOOK(3);
	RTDBGAL(0, 0xF8000150, 0,0); /* Result */
	tr1 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(8536, "font_names_on_system", loc1))(loc1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTNHOOK(3,1);
	tr2 = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(2333, "linear_representation", tr1))(tr1)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	Result = (EIF_REFERENCE) RTCCL(tr2);
	RTHOOK(4);
...
{
	GTCX
	RTOTS (12946,F1404_12946)
	RTOTS (12951,F1404_12951)
}
